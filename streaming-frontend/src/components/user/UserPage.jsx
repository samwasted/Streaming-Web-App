...
function UserPage() {
  ...
  const username = user ? user.data.preferred_username : 'Guest';
    ...
    <div className="min-h-screen text-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center space-y-6 mb-10">
          <h1 className="text-4xl font-bold text-blue-400">My Videos</h1>
          <p className="text-xl text-blue-300">Hello, {userName}!</p>
        ...
        {loading ? (
          ...
          <div className="text-center p-12 bg-gray-900 rounded-lg border border-blue-500">
            <p className="text-blue-300 mb-4">Please log in to view your videos</p>
