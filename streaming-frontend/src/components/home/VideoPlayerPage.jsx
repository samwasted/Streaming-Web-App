    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6 flex justify-between items-center">
          ...
          {/* Delete button is visible only to admin users */}
          <button 
            onClick={handleDeleteVideo}
            disabled={deleting}
            className={`px-4 py-2 rounded-md flex items-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${isAdmin ? 'bg-gray-800 hover:bg-gray-700 text-white' : 'invisible'}`}
          >
            {deleting ? (
              <>
